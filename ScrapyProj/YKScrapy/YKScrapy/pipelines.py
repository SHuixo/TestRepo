...
class MySQLPipeline(object):
    ...
    def _conditional_insert(self, tx, item):
        sql = "insert into youkusrc(crawler_app_id1,crawler_app_id2,crawler_app_id3,crawler_name,crawler_name2,crawler_actor,crawler_property,crawler_content_type) " \
